...
t4 = Transaction.create(user_id: u1.id, payer_id: p1.id, init_amount: 50, active_amount: 50, earn_timestamp: formatTimestamp("2021-03-04T11:00:00-08:00" ))
...
t6 = Transaction.create(user_id: u1.id, payer_id: p4.id, init_amount: 800, active_amount: 800, earn_timestamp: formatTimestamp("2021-05-27T04:00:00-07:00"))
t6.process_new_transaction


#User 2 transactions
t7 = Transaction.create(user_id: u2.id, payer_id: p1.id, init_amount: 10000, active_amount: 10000, earn_timestamp: formatTimestamp("2021-05-04T11:00:00-08:00"))
t7.process_new_transaction
t8 = Transaction.create(user_id: u2.id, payer_id: p2.id, init_amount: 10000, active_amount: 10000, earn_timestamp: formatTimestamp("2021-04-04T11:00:00-08:00"))
t8.process_new_transaction
t9 = Transaction.create(user_id: u2.id, payer_id: p3.id, init_amount: 10000, active_amount: 10000, earn_timestamp: formatTimestamp("2021-03-04T11:00:00-08:00"))
t9.process_new_transaction
t10 = Transaction.create(user_id: u2.id, payer_id: p4.id, init_amount: 10000, active_amount: 10000, earn_timestamp: formatTimestamp("2021-01-04T11:00:00-08:00"))
t10.process_new_transaction
